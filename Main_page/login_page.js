document.getElementById("new_workout_plan").addEventListener("click", function() {
...
let save_workout = document.getElementById("save_workout").addEventListener("click", function() {
    let exercise_name = document.getElementById("exercise_name").value;
    let reps = document.getElementById("another_sets_number").value;
    let weight = Number((document.getElementById("sets_number").value)) * Number((document.getElementById("another_sets_number")).value)
...
let click_followed_users = document.getElementById("all_user").addEventListener("click", function() {
    ...
    for(let i = 0; i < 6; i++) {
        ...
        all_user_div.style.height = "110px"
        ...
        user_image_div.style.height = "100px"
        user_image_div.style.marginTop = "2%"
        // user_image_div.style.border = "thick solid black"
        user_image_div.style.borderRadius = "50%"
        let img = document.createElement("img")
        img.src = "https://www.gymwolf.com/user_images/1f403368a68c64b8d18b2837b4d9b2f7_1605459293.jpg"
        img.style.width = "100%"
        ...
        user_description_div.style.height = "100px"
